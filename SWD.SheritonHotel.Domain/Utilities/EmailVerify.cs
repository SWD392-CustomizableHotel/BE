                                          ...
                                          <td align='center' style='font-size: 0;'>
                                            <!--[if mso]><a href='' target='_blank' hidden>
                                              <v:roundrect xmlns:v='urn:schemas-microsoft-com:vml' xmlns:w='urn:schemas-microsoft-com:office:word' esdevVmlButton href='' style='height:56px; v-text-anchor:middle; width:520px' arcsize='50%' stroke='f' fillcolor='#7630f3'>
                                                ...
                                                <center style='color:#ffffff; font-family:Imprima, Arial, sans-serif; font-size:22px; font-weight:700; line-height:22px; mso-text-raise:1px'>Verify Account</center>
                                              </v:roundrect></a>
                                            <![endif]-->
                          ...
                          <td align='left' style='padding: 20px 40px;'>
                            <table cellpadding='0' cellspacing='0' width='100%'>
                              <tbody>
                                <tr>
                                  <td align='center' valign='top'>
                                    <p style='font-family: Imprima, Arial, sans-serif; line-height: 150%; letter-spacing: 0;'>If you didn't request to verify account, please ignore this email or reply to let us know. This verify account link is valid for the next 24 hours.<br><br>Thanks,<br>Sheriton Hotel<br><br></p>
